...
- RFC 4523 X.509 certificate, CRL, certificate pair, supported algorithm, PKI
  ...
  validity, subject-public-key algorithm, key usage, certificate-pair component
  assertions, CRL issuer, CRL date, and CRL-number ranges. Remaining RFC 4523
  identifier, alternate-name, policy, name-constraint, distribution-point,
  reason-flag, and private-key-validity components remain deferred.
...
- GitHub issue #198: partially completed RFC 4523 X.509 certificate schema
  ...
  uncommon X.509 identifier, alternate-name, policy, name-constraint,
  distribution-point, reason-flag, and private-key-validity components.
