...
- RFC 4523 X.509 certificate, CRL, certificate pair, supported algorithm, PKI
  ...
  `ADMD`, `PRMD`, `X121`, `T-ID`, `O`, `OU`, `UA-ID`, `S`, `G`, `I`, `GQ`) plus
  domain-defined `DD.<type>` attributes in GeneralSubtree bases, certificate-pair
  ...
  name-relative-to-CRL-issuer distribution points. Remaining RFC 4523 constructed
  or schema-specific open-type `otherName` values plus X.400 extension
...
- GitHub issue #198: partially completed RFC 4523 X.509 certificate schema
  ...
  constructed or schema-specific `otherName` open-type values plus X.400
  extension attribute component matching.
