...
- RFC 4523 X.509 certificate, CRL, certificate pair, supported algorithm, PKI
  ...
  GeneralSubtree minimum/maximum bounds, certificate-pair component assertions,
  CRL issuer, CRL date, CRL-number ranges, CRL authority key identifier, reason
  flags, full-name distribution points, and name-relative-to-CRL-issuer
  distribution points. Remaining RFC 4523 `otherName` value and X.400/EDI
...
- GitHub issue #198: partially completed RFC 4523 X.509 certificate schema
  ...
  `otherName` value and X.400/EDI general-name component matching.
