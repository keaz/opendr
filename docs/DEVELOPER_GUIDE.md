...
- The optional `x509` built-in schema bundle adds RFC 4523 X.509 certificate
  ...
  `UA-ID`, `S`, `G`, `I`, `GQ`) are supported in GeneralSubtree bases;
  ...
  open-type `otherName` values plus X.400 domain-defined and extension
  attributes remain tracked follow-up work.
