...
`I`, `GQ`), and domain-defined `DD.<type>` attributes rendered in RFC 2156
string form in GeneralSubtree bases;
...
values plus X.400 extension attributes, are rejected explicitly until
implemented.
