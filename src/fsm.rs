...
impl std::fmt::Debug for ConnectionFsmSet {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("ConnectionFsmSet")
...
/// Union type for authentication FSMs
pub enum AuthenticationFsm {
    Simple(DynAuthFsm),
    Sasl(DynSaslFsm),
}

impl std::fmt::Debug for AuthenticationFsm {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            AuthenticationFsm::Simple(_) => write!(f, "Simple(<AuthFsm>)"),
            AuthenticationFsm::Sasl(_) => write!(f, "Sasl(<SaslFsm>)"),
        }
    }
}

/// Union type for operation FSMs
...
impl std::fmt::Debug for OperationFsm {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            OperationFsm::Search(_) => write!(f, "Search(<SearchFsm>)"),
            OperationFsm::Write(_) => write!(f, "Write(<WriteFsm>)"),
            OperationFsm::Compare(_) => write!(f, "Compare(<CompareFsm>)"),
            OperationFsm::Extended(_) => write!(f, "Extended(<ExtendedOpFsm>)"),
            OperationFsm::Referral(_) => write!(f, "Referral(<ReferralFsm>)"),
            OperationFsm::BackendTxn(_) => write!(f, "BackendTxn(<BackendTxnFsm>)"),
        }
    }
}

/// Union type for replication FSMs
pub enum ReplicationFsm {
    Provider(DynReplicationProviderFsm),
    Consumer(DynReplicationConsumerFsm),
}

impl std::fmt::Debug for ReplicationFsm {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ReplicationFsm::Provider(_) => write!(f, "Provider(<ReplicationProviderFsm>)"),
            ReplicationFsm::Consumer(_) => write!(f, "Consumer(<ReplicationConsumerFsm>)"),
        }
    }
}
