...
impl LdapSchema {
    ...
    /// Load core LDAP schema from bundled LDIF files and runtime rule registries.
    ...
    fn load_core_schema_files(&mut self) {
        self.load_ldif_str(RFC4519_SCHEMA_LDIF)
            .expect("bundled RFC 4519 schema must load");
